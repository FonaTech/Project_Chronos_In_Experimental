...
class ChronosSFTTrainer:
    ...
    def _save(self, epoch, step):
        ...
        self.model.eval()
        save_state_dict_with_config(self.model, ckp, self.config, stage="sft")
        self.model.train()


def build_sft_loader(data_path, tokenizer, max_seq_len, batch_size, device="cpu", num_workers="auto"):
